    ...
    <BlogLayout>
      ...
      <div className={`space-y-12 md:space-y-20 transition-all duration-2000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        ...
        <section className="space-y-6">
          ...
          <div className="text-white/60 text-sm md:text-base leading-loose max-w-4xl space-y-6">
            <p>
              The paradigm shift brought by AI emerges as part of the <span className="text-white font-semibold">broader dialectic of human history</span>. In this age of <span className="text-white font-semibold">vast transformation</span>, I seek resonance with minds shaping the future.
            </p>

            <p>
              I place myself in both the world of creation and the world of ideas —
            </p>
            ...
            <ul className="space-y-3 pl-0">
              <li className="flex gap-3">
                ...
                <span>
                  Co-founding <a href="https://inftychi-website.zeabur.app" target="_blank" rel="noopener noreferrer" className="text-white font-semibold hover:text-white/80 transition-colors">Infinity Archive</a> with an exceptional team, building human-AI collaboration for mathematics and scientific discovery.
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-white/40 flex-shrink-0">•</span>
                <span>
                  Pursuing my PhD at the <a href="https://www.utoronto.ca" target="_blank" rel="noopener noreferrer" className="text-white font-semibold hover:text-white/80 transition-colors">University of Toronto</a>, within a vibrant community of thinkers and researchers whose openness and curiosity continually inspire new perspectives.
                </span>
              </li>
            </ul>
          </div>
